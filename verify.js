...
assert(uiCss.includes('--felt-gold-rgb'), 'gold felt highlight tokens');
...
assert(indexHtml.includes('content="#0a0814"'), 'index theme-color lounge bootstrap');
...
assert(uiCss.includes('--felt-gold-rgb'), 'felt gold rgb design token');
assert(uiCss.includes('rgb(var(--felt-gold-rgb)'), 'felt gold rgb token used in lounge chrome');
assert(uiCss.includes('--felt-gold'), 'felt gold hex design token');
assert(uiCss.includes('color: var(--felt-gold)'), 'felt gold hex token used for lounge chrome');
assert(fs.existsSync(path.join(__dirname, 'src/lib/designTokens.js')), 'design tokens module');
const designTokensSrc = fs.readFileSync(path.join(__dirname, 'src/lib/designTokens.js'), 'utf8');
assert(designTokensSrc.includes('FELT_GOLD'), 'felt gold hex export');
assert(highlightSrc.includes('designTokens'), 'highlight warm glow uses design tokens');
